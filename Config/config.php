...
function redirecionar(string $url): void { header("Location: $url"); exit; }
function usuario_logado(): ?array { return $_SESSION['usuario'] ?? null; }
function exigir_login(): void {
    if (!usuario_logado()) { $_SESSION['flash_erro'] = 'Faça login para continuar.'; redirecionar('index.php?p=login'); }
}
